...
import foldingPanelDividerLib from "../../../models/folding-panel-divider/lib/folding-panel-divider-lib.scad?raw";
import foldingPanelDividerPlate from "../../../models/folding-panel-divider/previews/plate.scad?raw";
import filamentSpoolRollerLib from "../../../models/filament-spool-roller/lib/filament-spool-roller-lib.scad?raw";
import fsrAssembled from "../../../models/filament-spool-roller/previews/assembled.scad?raw";
import fsrBox from "../../../models/filament-spool-roller/previews/box.scad?raw";
import fsrLaneLeft from "../../../models/filament-spool-roller/previews/lane-left.scad?raw";
import fsrLaneMid from "../../../models/filament-spool-roller/previews/lane-mid.scad?raw";
import fsrLaneRight from "../../../models/filament-spool-roller/previews/lane-right.scad?raw";
import fsrPlate1 from "../../../models/filament-spool-roller/previews/plate-1.scad?raw";
import fsrPlate2 from "../../../models/filament-spool-roller/previews/plate-2.scad?raw";
import fsrPlate3 from "../../../models/filament-spool-roller/previews/plate-3.scad?raw";
import fsrPlate4 from "../../../models/filament-spool-roller/previews/plate-4.scad?raw";
import fsrPlate5 from "../../../models/filament-spool-roller/previews/plate-5.scad?raw";
import fsrPlate6 from "../../../models/filament-spool-roller/previews/plate-6.scad?raw";
import fsrPlate7 from "../../../models/filament-spool-roller/previews/plate-7.scad?raw";
...
export const CUSTOMIZABLE_SOURCES: Record<string, { lib: string; previews: Record<string, string> }> = {
  ...
  "folding-panel-divider": {
    lib: foldingPanelDividerLib,
    previews: {
      plate: stripIncludes(foldingPanelDividerPlate),
    },
  },
  "filament-spool-roller": {
    lib: filamentSpoolRollerLib,
    previews: {
      assembled: stripIncludes(fsrAssembled),
      box: stripIncludes(fsrBox),
      "lane-left": stripIncludes(fsrLaneLeft),
      "lane-mid": stripIncludes(fsrLaneMid),
      "lane-right": stripIncludes(fsrLaneRight),
      "plate-1": stripIncludes(fsrPlate1),
      "plate-2": stripIncludes(fsrPlate2),
      "plate-3": stripIncludes(fsrPlate3),
      "plate-4": stripIncludes(fsrPlate4),
      "plate-5": stripIncludes(fsrPlate5),
      "plate-6": stripIncludes(fsrPlate6),
      "plate-7": stripIncludes(fsrPlate7),
