...
// ============================================================
// JNI exports for com.mmmaxwwwell.gallery3d.SlicerBridge
// ============================================================

JNIEXPORT void JNICALL
Java_com_mmmaxwwwell_gallery3d_SlicerBridge_nativeCreate(
...
JNIEXPORT void JNICALL
Java_com_mmmaxwwwell_gallery3d_SlicerBridge_nativeLoadSTL(
...
JNIEXPORT void JNICALL
Java_com_mmmaxwwwell_gallery3d_SlicerBridge_nativeLoad3MF(
    JNIEnv* env, jobject /* thiz */, jstring jpath)
{
    std::lock_guard<std::mutex> lock(g_mutex);
    if (!g_slicer) {
...
JNIEXPORT void JNICALL
Java_com_mmmaxwwwell_gallery3d_SlicerBridge_nativeSetConfig(
...
JNIEXPORT void JNICALL
Java_com_mmmaxwwwell_gallery3d_SlicerBridge_nativeSlice(
    JNIEnv* env, jobject /* thiz */)
{
    std::lock_guard<std::mutex> lock(g_mutex);
    if (!g_slicer) {
...
JNIEXPORT void JNICALL
Java_com_mmmaxwwwell_gallery3d_SlicerBridge_nativeExportGCode(
...
JNIEXPORT void JNICALL
Java_com_mmmaxwwwell_gallery3d_SlicerBridge_nativeDestroy(
    JNIEnv* env, jobject /* thiz */)
{
    std::lock_guard<std::mutex> lock(g_mutex);
